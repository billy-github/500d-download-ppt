...
class _500d_ppt:
    ...
    def __init__(self, initUrl, page, savedir):
        self.initUrl = initUrl
        self.page = page
        self.save_dir = savedir

        """"""
        # http://www.500d.me/ppt/moban/baogao/?pageNumber=2
        self.url_pattern = self.initUrl + "?pageNumber={}".format(self.page)
    ...
    def get_html(self):
        while True:
            ...
            # http://www.500d.me/ppt/moban/dabian/?pageNumber=2
            print(url)
            try:
    ...
    def parse_list(self):
        while True:
            ...
            if html is not None:
                ...
                list = etree_html.xpath("//li[@class='listItem']")
                for tr in list:
                    item = {}
                    title = tr.xpath("./div[@class='item']/p/a/text()")[0]
                    ...
                    imgUrl = tr.xpath("./div/a/img/@src")[0]
                    item["imgUrl"] = imgUrl;  # imgUrl
                    # print(imgUrl)

                    href = tr.xpath("./div[@class='item']/a/@href")[0]
                    item["href"] = href;  # href
                    # print(href)
    ...
    def run(self):
        ...
        print("--------一共获取{}份ppt模板--------".format(self.count))
...
if __name__ == '__main__':
    ...
    initUrl = "http://www.500d.me/ppt/moban/baogao/"  # 初始地址
    order = "工作汇报"  # 需要的类型
    pageStart = 0  # 开始页数
    pageEnd = 2  # 结束页数

    for page in range(pageStart, pageEnd):
        savedir = "D:\\0五百丁-ppt\\" + order + "-" + str(page) + "\\"
        if os.path.exists(savedir) is False:
            os.makedirs(savedir)
        ding = _500d_ppt(initUrl, page, savedir)
        ding.run()
